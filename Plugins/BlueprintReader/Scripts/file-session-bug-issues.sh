...
file_issue \
    ...
    "Every UPROPERTY kept the BP-authored Category string. Projects with house categorization (e.g. \`MyGame\`, \`MyGame|Subsection\`) had to manually rewrite each \`Category=\"Default\"\` / \`Category=\"Internal State\"\`. Added \`category_default\` + \`category_remap\` args." \
    "806a111" "PR #106"
