...
TEST_CASE("tools/list inventory snapshot: hash of canonical dump") {
	...
	REQUIRE(spec.size() == bpr::test::kExpectedToolCount);
	...
	// Re-baselined 2026-06-09 at 261 tools after +1 health_check (UX-P4a).
	// Re-baselined 2026-06-09 at 263 tools after +2 EDIT-5:
	// describe_k2node + generate_k2node_skeleton.
	// Re-baselined 2026-06-10 at 264 tools after +1 ui_list_widgets (TEST-2
	// P0) + get_modal_state gaining `buttons` in its description/schema.
	// Re-baselined 2026-06-11 at 265 tools after +1 ui_click (TEST-2 P1b).
	// Re-baselined 2026-06-12 at 266 tools after +1 ui_type (TEST-2 P1b).
	// Re-baselined 2026-06-12 at 267 tools after +1 ui_focus_tab (TEST-2 P1b).
	// Re-baselined 2026-06-13 at 268 tools after +1 ui_invoke_menu (TEST-2 P1b).
	constexpr uint64_t kCurrentToolsHash = 0x095F3EC9B68D5F6CULL;
