...
class SHOOTERTESTSRUNTIME_API AAsyncColorChangeBroadcastActor : public AActor
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(BlueprintType)
class SHOOTERTESTSRUNTIME_API AColorChangingTestListener : public AActor
{
	GENERATED_BODY()
public:
 ...
 */
UCLASS(BlueprintType)
class SHOOTERTESTSRUNTIME_API AHeavyPerformanceBroadcastor : public AActor
{
	GENERATED_BODY()
...
UCLASS(BlueprintType)
class SHOOTERTESTSRUNTIME_API AHeavyPerformanceListener : public AActor
{
	GENERATED_BODY()
