...
| 14 | **EA-pull Wave 4** World + SCC + system state **(14 of ~25 SHIPPED — +get_streaming_sources (World Partition); world/SCC/system/registry/data-layer/streaming)** | 6–8 | 91d | Low (Med for Lyra: partition+data layers) | Partition, data layers, SCC, outliner, recent activity |
