...
| 13 | **EA-pull Wave 3** Viewport + visibility **(8 of ~17 SHIPPED — +visible_actors with frustum check; show_flags/view_mode/camera_transform already in Phase 8)** | 5–7 | 83d | Med — viewport-aware agent UX | Show flags, view mode, hover, gizmo, camera |
