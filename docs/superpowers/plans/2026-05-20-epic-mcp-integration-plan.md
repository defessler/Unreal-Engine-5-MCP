...
| 17 | **EA-pull Wave 5** Advanced + niche **(6 of ~20 SHIPPED — +get_blueprint_breakpoints via FKismetDebugUtilities; BP-debug: debug_instance + breakpoints)** | 5–7 | 113d | Very Low — demand-driven | BP debug, takes, render queue, modeling tools, console history |
