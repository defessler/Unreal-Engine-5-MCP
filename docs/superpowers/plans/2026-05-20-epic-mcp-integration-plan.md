...
| 13 | **EA-pull Wave 3** Viewport + visibility **(14 of ~17 SHIPPED — +6 viewport/layer writes: set_view_mode/set_gizmo_mode/set_viewport_realtime/set_actor_visibility/get_hidden_layers/set_layer_visibility; remaining: camera bookmarks + hover_target + isolate_mode)** | 5–7 | 83d | Med — viewport-aware agent UX | Show flags, view mode, hover, gizmo, camera |
