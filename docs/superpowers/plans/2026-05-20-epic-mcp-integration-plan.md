...
| 17 | **EA-pull Wave 5** Advanced + niche **(7 of ~20 SHIPPED — BP-debug trio complete: debug_instance/breakpoints/watched_pins + culture/theme/monitor/live_coding)** | 5–7 | 113d | Very Low — demand-driven | BP debug, takes, render queue, modeling tools, console history |
