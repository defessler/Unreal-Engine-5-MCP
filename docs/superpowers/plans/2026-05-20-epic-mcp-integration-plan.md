...
| 12 | **EA-pull Wave 2** Per-asset-editor selection **(5 of ~15 SHIPPED — bp_editor_state, mi_params, static_mesh_info, umg_editor_state, material_editor_state)** | 6–8 | 76d | Med — drills into specific workflows | BP/Material/Sequencer/Anim/UMG selection state |
