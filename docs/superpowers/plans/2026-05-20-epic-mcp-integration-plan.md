...
| 12 | **EA-pull Wave 2** Per-asset-editor selection **(1 of ~15 SHIPPED — get_blueprint_editor_state)** | 6–8 | 76d | Med — drills into specific workflows | BP/Material/Sequencer/Anim/UMG selection state |
