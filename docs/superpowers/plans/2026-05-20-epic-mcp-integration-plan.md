...
| 8 | **EA-pull Wave 1** Core awareness **(20 of 25 tools SHIPPED locally — partial)** | — | 0d | — | Selection, open, compile, modal, viewport, components, content-browser — the "what's the user doing?" core |
