...
| 12 | **EA-pull Wave 2** Per-asset-editor selection **(9 of ~15 — adds anim_editor_state as stub; Persona toolkit access needs registry approach)** | 6–8 | 76d | Med — drills into specific workflows | BP/Material/Sequencer/Anim/UMG selection state |
