...
| 12 | **EA-pull Wave 2** Per-asset-editor selection **(7 of ~15 SHIPPED — bp/material/umg/mi/static_mesh/mesh_preview/cinematic_camera)** | 6–8 | 76d | Med — drills into specific workflows | BP/Material/Sequencer/Anim/UMG selection state |
