...
| 11 | **H Tier 1** PluginToolset + GameFeatures + GAS **(reads SHIPPED for all 3 toolsets — 7 of 12 in scope; write ops + 2 more GAS reads pending)** | 10–12 | 68d | Med (High for Lyra users) | Lyra value-add |
