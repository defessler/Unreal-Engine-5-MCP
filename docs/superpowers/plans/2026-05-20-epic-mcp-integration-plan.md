...
| 16 | **H Tier 2** ConfigSettings + Automation **(3 of ~8 SHIPPED — ConfigSettings get/set core: list/get_values/set_project_setting; automation discovery + reset pending)** | 6–8 | 106d | Low (Med for Lyra) | More Lyra value-add |
