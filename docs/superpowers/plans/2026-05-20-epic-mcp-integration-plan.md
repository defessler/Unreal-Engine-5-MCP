...
| 17 | **EA-pull Wave 5** Advanced + niche **(5 of ~20 SHIPPED — +get_debug_instance via UBlueprint::GetObjectBeingDebugged)** | 5–7 | 113d | Very Low — demand-driven | BP debug, takes, render queue, modeling tools, console history |
