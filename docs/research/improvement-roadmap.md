...
- **Status:** ◑ a/b/d done (2026-06-11); c/e already-shipped (stale build); e1 deferred · **Effort:** S–M · **Source:** 2026-06-11 client issue report (UE 5.7.4 Polaris, single repro asset with two K2Node_FunctionResult nodes sharing pin GUIDs)
